...
export const Home = () => {
  ...
  return (
    <section className={styles.container}>
      ...
      <motion.h1 className={styles.title} {...motionProps} transition={{ duration: 0.9 }}>
        <span />
        <span className={styles.name}>Maximiliano</span>
        <span className={styles.lastName}>Pezzotta.</span>
      </motion.h1>

      <motion.h2 className={styles.subtitle} {...motionProps} transition={{ duration: 1.2 }}>
        I build digital solutions for the web.
      </motion.h2>

      <motion.p className={styles.description} {...motionProps} transition={{ duration: 1.4 }}>
      ...
      <motion.div {...motionProps} transition={{ duration: 1.5 }} className={styles.sections}>
